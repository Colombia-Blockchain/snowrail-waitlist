  ...
  return (
    <section id="use-cases" className="px-6 py-20">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-snow-0 mb-4 text-center">
          Who is this for?
        </h2>
        <p className="text-snow-1 text-center mb-12 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {segments.map((segment) => (
            <div
              key={segment.title}
              className="p-6 rounded-2xl glass-subtle glass-hover cursor-default"
            >
              <div className="w-12 h-12 bg-gradient-to-br from-cyan/20 to-blue/15 rounded-xl flex items-center justify-center text-cyan mb-4 border border-stroke">
                {segment.icon}
              </div>
              <h3 className="text-xl font-semibold text-snow-0 mb-2">
                {segment.title}
              </h3>
              <p className="text-snow-1 leading-relaxed">
                {segment.description}
              </p>
            </div>
          ))}
